...
<form name="managerhiddenForm" id="managerhiddenForm" action="demo.htm" method="post">
	      ...
	      <tr>
	        ...
	        <td bgcolor="#f3ffe3">
	        	<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98" onmouseover="changeto()"  onmouseout="changeback()">
					<tr>
						<td width="10%" height="25" background="../images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">选择</div></td>
						...
						<td width="20%" height="18" background="../images/web/tab/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">操作</div></td>
					</tr>
					...
					<tr id="${serial.index+1 }" align="center"
						...
						<td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1"><input name="checkbox" type="checkbox" class="STYLE2" value="checkbox" /></div></td>
					...
					<tr bgcolor="white">
						<td colspan="5" height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">没有数据</div></td>
					</tr>
					</c:if>
				</table>
	        </td>
	    ...
	    <td height="29">
		    <table width="100%" border="0" cellspacing="0" cellpadding="0">
		      <tr>
		        ...
		        <td background="../images/web/tab/images/tab_21.gif" align="right" class="STYLE2 STYLE1">
